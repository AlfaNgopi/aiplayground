<x-layouts.app>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Characters</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Manage System Characters</p>
        </div>
        <div class="flex gap-2">
            @if(auth()->user()->hasPermission('download-characters' ))
            <a href="{{ route('characters.export') }}">
            ...
            @endif
            @if(auth()->user()->hasPermission('create-characters'))
            <a href="{{ route('characters.create') }}">
                <x-button type="primary">{{ __('Create Character') }}</x-button>
            </a>
            @endif
            ...
            <table id="dynamic-table" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Character</th>
    ...
    <script>
        $(document).ready(function() {
            $('#dynamic-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("characters.indexTable") }}',
                columns: [
                ...
                language: {
                    ...
                    emptyTable: "No Characters available"
                },
